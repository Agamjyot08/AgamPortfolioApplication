...
public class MenuUtil  {
    ...
    public static List<MenuItems> getMenuList() {
        ...
        list.add(new MenuItems(R.drawable.ic_baseline_home_24,HOME_FRAGMENT_CODE,true));
        list.add(new MenuItems(R.drawable.ic_baseline_school_24,CV_FRAGMENT_CODE,false));
        list.add(new MenuItems(R.drawable.ic_baseline_group_24,TEAM_FRAGMENT_CODE,false));
        list.add(new MenuItems(R.drawable.ic_baseline_dashboard_24,PORTFOLIO_FRAGMENT_CODE,false));
